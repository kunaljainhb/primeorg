...
export function RichTextEditor({ id, placeholder, rows, required, value: extValue, onChange }: any) {
  ...
  return (
    <div className="border border-gray-200 rounded-xl overflow-hidden focus-within:ring-1 focus-within:ring-[var(--fnrc-primary-green)]/30 focus-within:border-[var(--fnrc-primary-green)] transition-all bg-white">
